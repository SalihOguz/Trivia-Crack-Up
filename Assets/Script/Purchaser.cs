...
public class Purchaser1 : MonoBehaviour{//, IStoreListener {
    ...
    //     Debug.Log("OnInitialized: PASS - " + controller.products.all.Count());
    ...
    //     menuManager.updatePriceList(controller.products.all);
    // }
